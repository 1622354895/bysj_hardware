...
////#define PROID		"i4g9oLr6AU"//产品ID

////#define AUTH_INFO	"version=2022-05-01&res=userid%2F337011&et=1713539735&method=sha1&sign=KsrIAZg5BQsNRp%2B5rhsqT3XSCTo%3D"//鉴权信息（自定义）

////#define DEVID		"mqtt1"//设备ID
...
////	{
////		ESP8266_SendData_2(mqttPacket._data, mqttPacket._len);			//上传平台
////		
...
//					
//					ESP8266_SendData_2(mqttPacket._data, mqttPacket._len);			//回复命令
//					MQTT_DeleteBuffer(&mqttPacket);									//删包
//				}
...
////        
////    {  printf( " 的v发生过\r\n");
////        ESP8266_SendData_2(mqtt_packet._data, mqtt_packet._len);   //向平台发送订阅请求
////        delay_ms(500);
